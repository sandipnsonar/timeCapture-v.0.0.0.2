...
public class LocationService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.d(TAG, "Location Service Received locationTimeout: " + locationTimeout + " ms, minDistance: " + minDistance + " meters");
        return START_STICKY;
    }
    ...
    private Notification getNotification() {
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setSmallIcon(R.drawable.ic_location) // Ensure this icon exists in your drawable resources
                .build();
    }
